...
--		textures[i] = Texture.new(xtexpaths[i], false, { format=TextureBase.RGBA4444}) -- best win32 perfs but b&w!
--		textures[i] = Texture.new(xtexpaths[i], false, { format=TextureBase.RGBA5551}) -- best win32 perfs but b&w!
	end
	-- map size
